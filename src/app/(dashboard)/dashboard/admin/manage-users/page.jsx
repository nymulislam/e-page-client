...
export default function ManageUsers() {
  ...
  const getRoleBadge = (role) => {
    switch (role) {
      ...
      default:
        return <span className="flex items-center gap-1.5 w-fit px-2.5 py-1 rounded-md bg-gray-100 text-gray-700 text-xs font-semibold"><BiBookReader size={14} />Reader</span>;
    }
  };
