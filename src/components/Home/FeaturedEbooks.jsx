  ...
  useEffect(() => {
    const fetchFeatured = async () => {
      try {
        ...
        // প্রথম ৬টি বইকে Featured হিসেবে দেখানো হচ্ছে, 
        // আপনার API-তে 'isFeatured' ফিল্ড থাকলে সেভাবেও ফিল্টার করতে পারেন।
      ...
      {isLoading ? (
        ...
        >
          {featuredEbooks.map((book) => (
            <Link href={`/ebooks/${book.id || book._id}`} key={book.id || book._id} className="block group">
              <motion.div
